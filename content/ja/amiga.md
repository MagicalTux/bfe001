...
<div class="mem-block">
<span class="label">AMIGA_CHIPSET</span> <span class="comment">; OCS / ECS ブロック図</span>

                  <span class="keyword">┌──────────────────────────┐</span>
                  <span class="keyword">│</span>    <span class="val">Motorola 68000</span>         <span class="keyword">│</span>
                  <span class="keyword">│</span>    <span class="dim">16ビットデータバス</span>       <span class="keyword">│</span>
                  <span class="keyword">│</span>    <span class="dim">24ビットアドレスバス</span>     <span class="keyword">│</span>
                  <span class="keyword">└──────────┬───────────────┘</span>
                             <span class="dim">│</span>
          <span class="dim">═══════════════════╪════════════════════════</span>
          <span class="dim">│                   │                      │</span>
  ...
  <span class="keyword">│</span> <span class="dim">DMAコントローラ</span><span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">映像出力</span>    <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">4chオーディオ</span> <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">Copper</span>        <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">ビットプレーン</span><span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">ディスクI/O</span>   <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">Blitter</span>       <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">スプライト</span>  <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">シリアルI/O</span>   <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">ビームカウンタ</span> <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">衝突検出</span>    <span class="keyword">│</span>  <span class="keyword">│</span> <span class="dim">割り込み</span>      <span class="keyword">│</span>
  <span class="keyword">└───────────────┘</span>  <span class="keyword">└─────────────┘</span>  <span class="keyword">└──────────────┘</span>
  ...
  <span class="keyword">│</span> <span class="dim">キーボード</span>     <span class="keyword">│</span>                  <span class="keyword">│</span> <span class="dim">パラレルポート</span> <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">ゲームポート</span>   <span class="keyword">│</span>                  <span class="keyword">│</span> <span class="dim">ディスク制御</span>   <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">LED / フィルタ</span> <span class="keyword">│</span>                  <span class="keyword">│</span> <span class="dim">シリアル制御</span>   <span class="keyword">│</span>
  <span class="keyword">│</span> <span class="dim">タイマー A/B</span>   <span class="keyword">│</span>                  <span class="keyword">│</span> <span class="dim">タイマー C/D</span>   <span class="keyword">│</span>
  <span class="keyword">└───────────────┘</span>                  <span class="keyword">└───────────────┘</span>
</div>
...
<div class="mem-block">
<span class="label">MEMORY_MAP</span> <span class="comment">; 68000 24ビットアドレス空間 (16 MB)</span>

  <span class="keyword">$000000</span>  <span class="val">┌──────────────────────────────────────┐</span>
           <span class="val">│</span>  <span class="val">チップRAM</span>                          <span class="val">│</span>
           <span class="val">│</span>  <span class="dim">最大 2 MB</span>                           <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; CPUとカスタムチップの共有</span>          <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; グラフィックス、オーディオ、ディスクデータ</span><span class="val">│</span>
  <span class="keyword">$200000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="val">ファストRAM / Zorro II</span>              <span class="val">│</span>
           <span class="val">│</span>  <span class="dim">最大 8 MB</span>                           <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; CPU専用、DMA競合なし</span>              <span class="val">│</span>
  <span class="keyword">$A00000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="dim">予約領域</span>                             <span class="val">│</span>
  <span class="keyword">$BFD000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="val">CIA-B レジスタ</span>                      <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; パラレル、ディスク、シリアル制御</span>    <span class="val">│</span>
  <span class="keyword">$BFE001</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="highlight">CIA-A レジスタ ★</span>                    <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; キーボード、LED、フィルタ、ゲームポート</span><span class="val">│</span>
  <span class="keyword">$C00000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="val">スローRAM</span> <span class="dim">（A500 トラップドア）</span>     <span class="val">│</span>
           <span class="val">│</span>  <span class="dim">512 KB</span>                              <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; バス共有だがDMAアクセスなし</span>        <span class="val">│</span>
  <span class="keyword">$D00000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="dim">予約 / 拡張</span>                         <span class="val">│</span>
  <span class="keyword">$DFF000</span>  <span class="val">├──────────────────────────────────────┤</span>
           <span class="val">│</span>  <span class="val">カスタムチップレジスタ</span>               <span class="val">│</span>
           <span class="val">│</span>  <span class="dim">約256レジスタ</span>                        <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; Agnus, Denise, Paula</span>              <span class="val">│</span>
           <span class="val">│</span>  <span class="comment">; ビットプレーン、スプライト、色、DMA</span> <span class="val">│</span>
  ...
  <span class="keyword">$F80000</span>  <span class="val">├──────────────────────────────────────┤</span>
           ...
           <span class="val">│</span>  <span class="comment">; Amiga OSカーネル全体</span>              <span class="val">│</span>
...
<div class="mem-block">
<span class="label">$BFE001 — PRA</span> <span class="comment">; ポートレジスタA — ビットごとの説明</span>

  <span class="dim">Bit</span>  <span class="dim">方向</span>  <span class="dim">名前</span>     <span class="dim">機能</span>
  <span class="keyword"> 7 </span>  <span class="val">入力</span>  <span class="keyword">/FIR1</span>    <span class="comment">ゲームポート1 発射ボタン（アクティブロー）</span>
  <span class="keyword"> 6 </span>  <span class="val">入力</span>  <span class="keyword">/FIR0</span>    <span class="comment">ゲームポート0 発射ボタン（アクティブロー）</span>
  <span class="keyword"> 5 </span>  <span class="val">入力</span>  <span class="keyword">/RDY</span>     <span class="comment">ディスクレディ（アクティブロー）</span>
  <span class="keyword"> 4 </span>  <span class="val">入力</span>  <span class="keyword">/TK0</span>     <span class="comment">ディスクトラックゼロ（アクティブロー）</span>
  <span class="keyword"> 3 </span>  <span class="val">入力</span>  <span class="keyword">/WPRO</span>    <span class="comment">ディスク書き込み禁止（アクティブロー）</span>
  <span class="keyword"> 2 </span>  <span class="val">入力</span>  <span class="keyword">/CHNG</span>    <span class="comment">ディスクチェンジ（アクティブロー）</span>
  <span class="keyword"> 1 </span>  <span class="highlight">出力</span>  <span class="highlight">LED</span>      <span class="highlight">電源LED / オーディオローパスフィルタ</span>
  <span class="keyword"> 0 </span>  <span class="val">出力</span>  <span class="keyword">OVL</span>      <span class="comment">オーバーレイ — 1: ROMを$000000に, 0: RAM</span>
</div>
