...
万世橋での生活：約7平方メートルの独房、完全には消えないライト、時に8時間に及ぶ日々の取り調べ。4ヶ月半の間に約35キログラム体重が減少した。

万世橋で4ヶ月半を過ごした後、東京北東部の**東京拘置所**（小菅）に移送された。公判前勾留者と受刑者を収容する大規模施設だ。ここが以降7ヶ月の住処となった。条件はいくらか改善され、小菅では逆に約5キロ増加した。
