...
- **[strtotime](https://github.com/KarpelesLab/strtotime)** — 17
  commits warming up before the final push that landed on the 13th
  (covered in the [w16 post](weekly-2026-w16.html)).
- **[libwallet](https://github.com/KarpelesLab/libwallet)** — 12
  commits of incremental work ahead of the Swap API release the
  following week.
...
OxideAV public launch — [already covered](weekly-2026-w16.html).
